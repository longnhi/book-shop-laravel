            ...
            <div class="card shadow mb-4">
                <div class="card-header">
                    <div class="text-center avatar-xl">
                        <img src="{{URL::TO('/templates/admin/assets/images/no-image-icon-6.png')}}" alt="..." class="avatar-img"
                            id="image_preview">
                    </div>
                </div>
                <div class="card-body">
                    <form class="needs-validation" enctype="multipart/form-data" method="post" action="{{URL::TO('/admin/products/store')}}" >
                        {{csrf_field()}}
                        <div class="form-row">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <textarea class="form-control" id="information" name="information"
                                placeholder="Required example textarea" rows="8" required></textarea>
                        </div>
                        <div class="form-group mb-3">
                            <label for="Image">Image</label>
                            <div class="card shadow">
                                <div class="card-body">
                                    <input type="file" id="Image" name="image" class="form-control-file" onchange="loadImageBook(event)" required>
                                </div>
                            </div> <!-- /.card-body -->
                        </div> <!-- /.card -->
